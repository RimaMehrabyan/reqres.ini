...
@allure.description('Test the API endpoint to update details of an existing user using PATCH method')
...
def test_update(user_for_update):
    ...
    with allure.step(f"Send PATCH request to update details of user with ID {user_id}"):
